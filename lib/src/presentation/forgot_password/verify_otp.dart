...
class VerifyOTPPage extends StatefulWidget {
  ...
  const VerifyOTPPage({Key? key, required this.userEmail}) : super(key: key);
                              ...
                              child: ElevatedButton(
                                onPressed: _otp?.length == 6
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    final response = await AuthProvider().forgetPasswordVerifyOTP(otp: '$_otp');
                            ...
                            isCountdownFinish ? Align(
                              ...
                              child: TextButton(
                                onPressed: (_countdown == 0)
                                  ...
                                  AuthProvider().forgetPassword(email: widget.userEmail);
